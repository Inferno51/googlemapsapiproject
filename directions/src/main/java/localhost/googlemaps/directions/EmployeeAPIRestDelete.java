...
public class EmployeeAPIRestDelete {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String queryString = String.format("id=%s", URLEncoder.encode(employeeID, charset));
			...
			connection.setRequestMethod("DELETE"); // Sets the requestMethod to POST to create new records
